...
function Renderer(conf) {
  ...
  function load(nameOrTemplate, chunk, context) {
	...
	* Context Object
	********************************************************/
  function Context(renderer, stack, global, options, blocks, templateName) {
  ...
  Context.wrap = function(context, name) {
    ...
    return new Context(this.renderer, context, {}, {}, null, name);
  };
  ...
  Context.prototype.rebase = function(head) {
    return new Context(this.renderer, head, this.global, this.options, this.blocks, this.getTemplateName());
  };
  ...
  Context.prototype.getBlock = function(key) {
    ...
    if (typeof key === 'function') {
      key = key(new Chunk(this.renderer), this).data.join('');
    }
  ...
  Context.prototype.shiftBlocks = function(locals) {
    ...
    if (locals) {
      ...
      return new Context(this.renderer, this.stack, this.global, this.options, newBlocks, this.getTemplateName());
    }
    return this;
  };
  ...
  Context.prototype.resolve = function(body) {
    ...
    chunk = new Chunk(this.renderer).render(body, this);
  ...
  function Stack(head, tail, idx, len) {
	...
	* Stub Object
	********************************************************/
  function Stub(renderer, callback) {
		this.renderer = renderer;
    this.head = new Chunk(renderer, this);
